    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> {
                ...
                authorize.requestMatchers(HttpMethod.POST, "/api/catalogos/**").hasAuthority(Permisos.GESTIONAR_INVENTARIO);
                authorize.requestMatchers(HttpMethod.PUT, "/api/catalogos/**").hasAuthority(Permisos.GESTIONAR_INVENTARIO);
                authorize.requestMatchers(HttpMethod.DELETE, "/api/catalogos/**").hasAuthority(Permisos.GESTIONAR_INVENTARIO);
    ...
    public PasswordEncoder passwordEncoder() {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(authorize -> {
                                        // Recursos públicos
                                        authorize.requestMatchers("/css/**", "/js/**", "/img/**", "/images/**",
                                                        "/login",
                                                        "/forgot-password", "/forgot-password/**").permitAll();
                                        authorize.requestMatchers("/api/auth/login", "/api/auth/forgot-password/**")
                                                        .permitAll();
                                        authorize.requestMatchers("/api/productos/**").permitAll();

                                        // INICIOVC: rutas públicas para la vista cliente
                                        authorize.requestMatchers("/", "/index", "/cliente/**", "/Detalles_web/**")
                                                        .permitAll();
                                        // FIN INICIOVC
                                        ...
                                        authorize.requestMatchers(HttpMethod.PUT, "/ventas/api/**")
                                                        .hasAuthority(Permisos.REGISTRAR_VENTAS);
                                        ...
                                        authorize.requestMatchers(HttpMethod.GET, "/api/proveedores/**")
                                                        .hasAnyAuthority(
                                                                        Permisos.GESTIONAR_COMPRAS,
                                                                        Permisos.VER_PROVEEDORES,
                                                                        Permisos.MODULO_PROVEEDORES,
                                        ...
                                        authorize.requestMatchers(HttpMethod.GET, "/api/roles/**").hasAnyAuthority(
                                                        ...
                                                        Permisos.VER_ROLES,
                                                        Permisos.MODULO_ROLES);
                                        authorize.requestMatchers(HttpMethod.POST, "/api/roles/**")
                                                        .hasAuthority(Permisos.GESTIONAR_ROLES);
                                        authorize.requestMatchers(HttpMethod.PUT, "/api/roles/**")
                                                        .hasAuthority(Permisos.GESTIONAR_ROLES);
                                        authorize.requestMatchers(HttpMethod.PATCH, "/api/roles/**")
                                                        .hasAuthority(Permisos.GESTIONAR_ROLES);
