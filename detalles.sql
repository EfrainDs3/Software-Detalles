...
INSERT INTO `permisos` (`id_permiso`, `nombre_permiso`, `modulo`, `descripcion`, `estado`, `fecha_creacion`, `fecha_actualizacion`) VALUES
(1, 'Acceder al dashboard', 'Dashboard', 'Permite visualizar el panel principal', 'ACTIVO', '2025-10-14 20:53:43', '2025-10-15 05:00:47'),
(2, 'Ver usuarios', 'Usuarios', 'Permite visualizar la lista de usuarios', 'ACTIVO', '2025-10-14 20:53:43', '2025-10-14 20:53:43'),
(3, 'Gestionar usuarios', 'Usuarios', 'Permite crear, editar y eliminar usuarios', 'ACTIVO', '2025-10-14 20:53:43', '2025-10-14 20:53:43'),
(5, 'Gestionar roles', 'Roles', 'Permite crear, editar y eliminar roles', 'ACTIVO', '2025-10-14 20:53:43', '2025-10-14 20:53:43'),
(6, 'Ver permisos', 'Permisos', 'Permite visualizar permisos del sistema', 'ACTIVO', '2025-10-14 20:53:43', '2025-10-14 20:53:43'),
(7, 'Gestionar permisos', 'Permisos', 'Permite asignar y revocar permisos', 'ACTIVO', '2025-10-14 20:53:43', '2025-10-14 20:53:43'),
(8, 'Registrar ventas', 'Ventas', 'Permite registrar nuevas ventas', 'ACTIVO', '2025-10-14 20:53:43', '2025-10-14 20:53:43'),
(9, 'Gestionar inventario', 'Inventario', 'Permite gestionar stock y movimientos', 'ACTIVO', '2025-10-14 20:53:43', '2025-10-14 20:53:43'),
(10, 'Gestionar compras', 'Compras', 'Permite registrar órdenes de compra', 'ACTIVO', '2025-10-14 20:53:43', '2025-10-14 20:53:43'),
(12, 'barredor', 'General', 'barredor 1234', 'INACTIVO', '2025-10-16 15:02:02', '2025-10-22 13:25:42');
...
INSERT INTO `permisos_auditoria` (`id_auditoria`, `id_permiso`, `accion`, `detalle`, `usuario`, `permiso_nombre`, `fecha`) VALUES
(1, 1, 'ACTUALIZACION', 'Se actualizó el permiso', 'anonymousUser', 'Acceder al dashboard', '2025-10-15 05:00:01'),
(2, 1, 'ACTUALIZACION', 'Se actualizó el permiso', 'anonymousUser', 'Acceder al dashboard', '2025-10-15 05:00:47'),
(3, 9, 'ROL_ACTUALIZADO', 'Removido del rol Almacenero', 'anonymousUser', 'Gestionar inventario', '2025-10-16 03:09:00'),
(4, 1, 'ROL_ACTUALIZADO', 'Removido del rol Administrador', 'anonymousUser', 'Acceder al dashboard', '2025-10-16 03:12:58'),
(5, 2, 'ROL_ACTUALIZADO', 'Removido del rol Administrador', 'anonymousUser', 'Ver usuarios', '2025-10-16 03:12:58'),
(6, 3, 'ROL_ACTUALIZADO', 'Removido del rol Administrador', 'anonymousUser', 'Gestionar usuarios', '2025-10-16 03:12:58'),
(7, 4, 'ROL_ACTUALIZADO', 'Removido del rol Administrador', 'anonymousUser', 'Ver roles', '2025-10-16 03:12:58'),
(8, 5, 'ROL_ACTUALIZADO', 'Removido del rol Administrador', 'anonymousUser', 'Gestionar roles', '2025-10-16 03:12:58'),
(9, 6, 'ROL_ACTUALIZADO', 'Removido del rol Administrador', 'anonymousUser', 'Ver permisos', '2025-10-16 03:12:58'),
(10, 7, 'ROL_ACTUALIZADO', 'Removido del rol Administrador', 'anonymousUser', 'Gestionar permisos', '2025-10-16 03:12:58'),
(11, 8, 'ROL_ACTUALIZADO', 'Removido del rol Administrador', 'anonymousUser', 'Registrar ventas', '2025-10-16 03:12:58'),
(12, 9, 'ROL_ACTUALIZADO', 'Removido del rol Administrador', 'anonymousUser', 'Gestionar inventario', '2025-10-16 03:12:58'),
(13, 10, 'ROL_ACTUALIZADO', 'Removido del rol Administrador', 'anonymousUser', 'Gestionar compras', '2025-10-16 03:12:58'),
(14, 2, 'ROL_ACTUALIZADO', 'Asignado al rol PruebaPermisos', 'anonymousUser', 'Ver usuarios', '2025-10-16 04:25:44'),
(15, 3, 'ROL_ACTUALIZADO', 'Asignado al rol PruebaPermisos', 'anonymousUser', 'Gestionar usuarios', '2025-10-16 04:25:44'),
(16, 9, 'ROL_ACTUALIZADO', 'Asignado al rol PruebaPermisos', 'anonymousUser', 'Gestionar inventario', '2025-10-16 04:25:44'),
(17, 1, 'ROL_ACTUALIZADO', 'Asignado al rol PruebaPermisos', 'anonymousUser', 'Acceder al dashboard', '2025-10-16 04:26:05'),
(18, 7, 'ROL_ACTUALIZADO', 'Asignado al rol PruebaPermisos', 'anonymousUser', 'Gestionar permisos', '2025-10-16 04:26:05'),
(19, 2, 'ROL_ACTUALIZADO', 'Removido del rol PruebaPermisos', 'anonymousUser', 'Ver usuarios', '2025-10-16 04:26:05'),
(20, 3, 'ROL_ACTUALIZADO', 'Removido del rol PruebaPermisos', 'anonymousUser', 'Gestionar usuarios', '2025-10-16 04:26:05'),
(21, 9, 'ROL_ACTUALIZADO', 'Removido del rol PruebaPermisos', 'anonymousUser', 'Gestionar inventario', '2025-10-16 04:26:05'),
(22, 11, 'CREACION', 'Se creó el permiso', 'anonymousUser', 'Permiso de prueba', '2025-10-16 04:26:10'),
(29, 12, 'CREACION', 'Se creó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:02'),
(30, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:21'),
(31, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:27'),
(32, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:28'),
(33, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:28'),
(34, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:28'),
(35, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:28'),
(36, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:29'),
(37, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:29'),
(38, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:29'),
(39, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:29'),
(40, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:02:29'),
(41, 12, 'ACTUALIZACION', 'Se actualizó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:03:08'),
(42, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:03:15'),
(43, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:03:16'),
(44, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:03:16'),
(45, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:03:16'),
(46, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:03:16'),
(47, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:03:16'),
(48, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-16 15:03:17'),
(49, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:35'),
(50, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:38'),
(51, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:40'),
(52, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:41'),
(53, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:41'),
(54, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:41'),
(55, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:42'),
(56, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:42'),
(57, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:42'),
(58, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:42'),
(59, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:43'),
(60, 12, 'ELIMINACION', 'Se eliminó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:17:44'),
(61, 12, 'ACTUALIZACION', 'Se actualizó el permiso', 'anonymousUser', 'barredor', '2025-10-22 13:25:42');
